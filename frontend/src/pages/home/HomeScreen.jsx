  ...
  if (!trendingContent) {
    return (
      <div className="h-screen text-white relative">
        <Navbar />
        <div
          className="absolute top-0 left-0 h-full w-full bg-black/70 flex items-center justify-center -z-10 shimmer"
          aria-hidden="true"
        />
      </div>
    );
    ...
    <>
      <div className="relative h-screen text-white">
        ...
        <div className="absolute top-0 left-0 h-full w-full flex flex-col justify-center px-8 md:px-16 lg:px-32">
          <div className="bg-gradient-to-b from-black via via-transparent to-transparent absolute w-full h-full top-0 left-0 -z-10" />
